//“Divisions”
//Usage : node terre05 [NUMBER] [NUMBER]
"use strict";
...
if (
  isNaN(parsed1) ||
  isNaN(parsed2) ||
  isNaN(parsed1 % parsed2) ||
  (parsed2 > 0 && parsed1 < parsed2) ||
  parsed1.toString() != process.argv[2] ||
  parsed2.toString() != process.argv[3]
) {
  console.log(lolNope);
} else {
  console.log("résultat: " + Math.floor(parsed1 / parsed2));
  console.log("reste: " + (parsed1 % parsed2));
}
